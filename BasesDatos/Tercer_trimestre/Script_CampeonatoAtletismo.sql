...
-- 5
 ...
 -- 8
 SELECT UNIVERSIDAD, SUM(PUNTOS) FROM COMPETIR INNER JOIN PRUEBA ON CODIGO_PRU = CODIGO INNER JOIN ATLETA ON DORSAL = DORSAL_ATL WHERE DISTANCIA != 3000 AND CATEGORIA IN('M','F') GROUP BY UNIVERSIDAD;
