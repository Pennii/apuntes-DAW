...
public class HuevoSorpresa_esqueleto {
...
public HuevoSorpresa_esqueleto(){}


/*Constructor por parámetros*/
public HuevoSorpresa_esqueleto(int unidades, double precio, String sorpresa, double precio_max){
