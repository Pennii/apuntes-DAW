...
public class Utilidades {
    ...
    private final static String[] nombresFemeninos = {"Luna", "M√≠a", "Nala", "Nina", "Lola", "India", "Misha"};
    ...
    private final static String[] razaGatos = {"Mestizo", "Siam√©s", "Azul ruso", "Europeo", "Americano", "Angora", "Snowshoe"};
    
    private final static String[] caracteristicas = {"Pelo corto", "Pelo largo", "Negro", "Blanco", "Manchas", "Pardo", "Casta√±o"};
    ...
    public static Mascota mascotaAleatoria() {
        ...
        // si aleatorio es par animal ser· perro; si aleatorio es impar animal ser· gato
