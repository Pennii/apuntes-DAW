...
public class CPersona implements Serializable {
    ...
    */
    ...
    /**
     * Mínimo año de nacimiento permitido: {@value FECHA_MINIMA}.
     */    
     ...
     * @param fechaNacimiento Fecha de nacimiento del contacto. Debe ser posterior a {@value FECHA_MINIMA}
     ...
     * @throws IllegalArgumentException si la fecha de nacimiento es anterior a {@value FECHA_MINIMA}
     */
    ...
    /**
     * Devuelve el listado de aficiones del contacto.
