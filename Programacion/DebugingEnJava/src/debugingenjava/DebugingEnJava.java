...
public class DebugingEnJava {
    ...
    public static void main(String[] args) {
        ...
        //                Entrada de datos 
        //----------------------------------------------
        System.out.println("ESCALERA INCREMENTAL: PRUEBA DEL ALUMNO Matias Agustin Pennino");     // Cambiar por "PRUEBA DEL ALUMNO NOMBRE APELLIDO1 APELLIDO2"
        System.out.println("------------------------------------------------------------------");
        do {
